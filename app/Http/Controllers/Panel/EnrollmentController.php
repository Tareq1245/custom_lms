...
class EnrollmentController extends Controller
{
    public function history(Request $request)
    {
        ...
        return view('web.default.panel.enrollment.history', $data);
    }
    ...
    public function addStudentToClass()
    {
        ...
        return view('web.default.panel.enrollment.add_student_to_a_class', $data);
    }
        ...
        if (!empty($user)) {
            ...
            if (!empty($itemType) and !empty($itemId) and !empty($itemColumnName) and !empty($sellerId)) {
                ...
                if ($request->ajax()) {
                    ...
                    return redirect('/panel/enrollments/history')->with(['toast' => $toastData]);
                }
            }
        }
