...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> <?php if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])): ?> without-bottom-image <?php endif; ?>" <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <?php endif; ?>
                ...
                <li class="sidenav-item <?php echo e((request()->is('panel/enrollments') or request()->is('panel/enrollments/*')) ? 'sidenav-item-active' : ''); ?>">
                    ...
                    <div class="collapse <?php echo e((request()->is('panel/enrollments') or request()->is('panel/enrollments/*')) ? 'show' : ''); ?>" id="enrollmentsCollapse">

                    <ul class="sidenav-item-collapse">
                            <li class="<?php echo e((request()->is('panel/enrollments/history') or request()->is('panel/enrollments/history/*')) ? 'sidenav-item-active' : ''); ?>">
                                <a class="nav-link" href="/panel/enrollments/history"><?php echo e(trans('public.history')); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('panel/enrollments/add-student-to-class') or request()->is('panel/enrollments/add-student-to-class/*')) ? 'sidenav-item-active' : ''); ?>">
                                <a class="nav-link" href="/panel/enrollments/add-student-to-class"><?php echo e(trans('update.add_student_to_a_class')); ?></a>
                            </li>
                    </ul>
                </div>
                </li>
...
<?php /**PATH C:\xampp\htdocs\rocketlms\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>