                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        <?php if(!empty(getGeneralSettings('content_translate'))): ?>
                                            <div class="form-group">
                                                ...
                                                <select name="locale" class="form-control <?php echo e(!empty($role) ? 'js-edit-content-locale' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <input type="text" name="caption" value="<?php echo e((!empty($role) and !empty($role->translate($locale))) ? $role->translate($locale)->caption : ''); ?>" class="js-ajax-caption form-control " placeholder="<?php echo e(trans('admin/main.create_field_name_placeholder')); ?>" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rocketlms\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>